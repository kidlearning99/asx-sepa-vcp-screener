...
const D=[{"status": "breakout", "vcpScore": 3, "sepaScore": 6, "price": 10.0, "change": 1.0, "volRatio": 1.5, "pvr": 2.0, "chg5d": 1.0, "chg60d": 5.0, "chg250d": 100.0, "mktcapFmt": "", "sector": "Tech", "ticker": "CBA", "name": "Commbank", "_ticker_raw": "CBA.AX", "stage": 2, "ohlcv": [], "candleSignals": ["Pocket Pivot"], "accDistRatio": 1.5, "checks": {"ma50": true, "ma150": true, "ma200": true, "trend": true, "high": true, "low": true, "vol": true}, "analysis": "Test", "fundScore": 0, "ma50": 9.0, "ma150": 8.0, "ma200": 7.0, "pctFromHigh": 5.0, "pctAboveLow": 50.0, "shortSignal": "", "revGrowth": null, "revTrend": null, "revQuarters": [], "epsGrowth": null, "netMargin": null, "trailingEps": null, "forwardEps": null, "nextEarnings": null, "nextEventLabel": null, "nextExDiv": null}];
...
function det(r){
  ...
  if(r.candleSignals && r.candleSignals.length > 0){
    for(var k=0; k<r.candleSignals.length; k++){
      ...
      var ico = sig.includes('Pivot') ? '⚡' : sig.includes('Squat') ? '🏋' : sig.includes('Inside') ? '🤫' : '🔄';
